...
【重要】
- 券面額只有：0元、10元、20元、50元、100元、200元（沒有270、70、40、30、50等面額！）
- 消費金額必須 ≥ 券面額×3 才能使用該券
- 實付 = 消費金額 - 券面額

【回答格式要非常簡潔】
消費 XXX 元，建議：
- [平臺A]: 支付 XXX元 (扣 YYY券) → 實付 XXX元
- [平臺B]: 支付 XXX元 (扣 YYY券) → 實付 XXX元

額外支付：XXX 元

【例子】
你有：中國銀行200元券×1，國際銀行50元券×1
消費1000元：
- 中國銀行: 消費600元 (扣200券) → 實付400元
- 國際銀行: 消費150元 (扣50券) → 實付100元
額外支付：500元
